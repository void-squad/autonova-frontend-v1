...
export default function CustomerProgressIndex() {
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="grid gap-4">
          {projects.length === 0 && !loading && (
            <Card>
              <CardContent>
                <div className="text-sm text-muted-foreground">You have no projects yet.</div>
              </CardContent>
            </Card>
          )}
            ...
            <Card key={p.id}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Link to={CUSTOMER_ROUTES.projectProgress(p.id)}>
